...
Turn this into a friendly plain-English recap they can read at the window. List what they are \
getting in KITCHEN LINE ORDER — the same sequence the crew builds the item and how it should read \
